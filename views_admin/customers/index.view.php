...
<div class="container-fluid px-4 mt-5">
    ...
    <div class="card mt-5 border-0 shadow-sm">
        <div class="card-body p-4">
            <button class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#addCustomerModal">Add Customer</button>
            ...
            <table class="table mt-4 text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= htmlspecialchars($customer['customer_address']); ?></td>
                        <td><?= htmlspecialchars($customer['customer_phone']); ?></td>
                        <td><?= htmlspecialchars($customer['created_time']); ?></td>
                        <td>
                            <a href="/admin/customer/show?id=<?= $customer['customer_id']; ?>" class="text-secondary text-decoration-none">
                                <i class="fa-solid fa-eye"></i>
                            </a>
                            <a href="#" class="text-decoration-none text-secondary" data-bs-toggle="modal" data-bs-target="#deleteCustomerModal<?= $customer['customer_id']; ?>">
                                <i class="fa-solid fa-trash"></i>
                            </a>
                            <a href="#" class="text-decoration-none text-secondary" data-bs-toggle="modal" data-bs-target="#editCustomerModal<?= $customer['customer_id']; ?>">
