...
<div class="container-fluid px-4 mt-5">
    ...
    <div class="card mt-5 border-0 shadow-sm">
        <div class="card-body p-4">
            <button class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#addUserModal">Add User</button>
            ...
            <table class="table mt-4 text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" class="text-decoration-none text-secondary" data-bs-toggle="modal" data-bs-target="#deleteUserModal<?= $user['user_id']; ?>">
                                <i class="fa-solid fa-trash"></i>
                            </a>
                            <a href="#" class="text-decoration-none text-secondary" data-bs-toggle="modal" data-bs-target="#editUserModal<?= $user['user_id']; ?>">
