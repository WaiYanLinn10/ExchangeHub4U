...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2025 at 08:12 PM
...
(8, 'Test', 'Testing', 1234567891, '0000-00-00', 2),
(11, 'aaaaaaa', 'dddddddddddd', 111111111, '0000-00-00', 22),
(12, 'ddddd', 'ddddddddddd', 123123123123, '0000-00-00', 45),
(13, 'ffff', 'fffffff', 12312312221, '0000-00-00', 47),
(14, 'gggg', 'ggggggg', 2132131212, '0000-00-00', 48);
...
(1, '2025-03-27', 'ahlone sdafsad', 0, 'sdafsa dsafsadf', 123213, 11),
(2, '2025-03-27', 'ahlone aaaa', 0, 'aaaa bbbb', 122222131231, 11),
(3, '2025-03-27', 'ahlone asdfasf', 0, 'dsaf dsfs', 1231231, 11),
(4, '2025-03-27', 'bahan dsafasd', 0, 'sddsd dsaf', 1231, 11);
...
(1, '0000-00-00', 9879400, 2, 11, 1, ''),
(2, '0000-00-00', 9879400, 1, 11, 2, '12321312'),
(3, '0000-00-00', 9879400, 2, 11, 3, ''),
(4, '0000-00-00', 8910000, 2, 11, 4, '');
...
--
ALTER TABLE `shoppingcart`
  MODIFY `shoppingcart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `shoppingcart_product`
--
ALTER TABLE `shoppingcart_product`
  MODIFY `shoppingcart_product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `wishlist_product`
  MODIFY `wishlist_product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
